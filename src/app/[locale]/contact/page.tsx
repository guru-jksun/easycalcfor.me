...
import { Mail, MessageSquare, Bug, ExternalLink, PlusCircle } from "lucide-react";
    ...
    <div className="container mx-auto px-4 max-w-3xl py-12">
      ...
      <section className="rounded-xl border bg-card p-6 mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="font-semibold text-lg">{t("contactGithub")}</h2>
            <p className="text-sm text-muted-foreground">{t("contactGithubDesc")}</p>
          </div>
        </div>

        <a
          href="https://github.com/guru-jksun/easycalcfor.me/issues"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 rounded-lg border border-gray-300 dark:border-gray-600 px-5 py-2.5 text-sm font-medium hover:bg-muted transition-colors"
        >
          <ExternalLink className="w-4 h-4" />
          {t("contactGithubButton")}
        </a>
      </section>
      ...
      <section className="rounded-xl border bg-card p-6 mb-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h2 className="font-semibold text-lg">{t("contactFeatureRequest")}</h2>
          </div>
        </div>
        <p className="text-sm text-muted-foreground">{t("contactFeatureRequestDesc")}</p>
      </section>
